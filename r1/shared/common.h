...
uniform half4		timers,fog_plane,dt_params,m_hud_params,screen_res,m_zoom_deviation,fog_color,L_hemi_color,L_ambient;
uniform half3		L_sun_color,L_sun_dir_w,L_sun_dir_e,eye_direction,eye_normal;

uniform float3 		eye_position;
uniform float4		fog_params,m_actor_params,m_affects,m_timearrow,m_timearrow2,m_digiclock;
